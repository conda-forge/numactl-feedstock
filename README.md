...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/numactl-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/numactl-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add libnuma numactl
# for installing globally
pixi global install libnuma numactl
```
...
It is possible to list all of the versions of `libnuma` available on your platform:
...
```
pixi search libnuma --channel conda-forge
```
